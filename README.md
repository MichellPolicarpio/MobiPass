...
- 📱 Visualización de boletos vigentes
- ✅ Validación de pasajes por número de bus
- ❌ Cancelación de boletos
- 📋 Historial de compras

### Gestión de Rutas
- 🗺️ Visualización de rutas disponibles
...
<div align="center">
  ...
  <img src="ReadmeImages/CrearCuentaOscuro.jpg" alt="Pantalla de Registro" width="180" height="354" style="border-radius: 10px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
</div>
